;(function ($) {
  var serverMenu = [
    ...
    },
    {
      name: 'jiankongzl',
      title: '调度一张图',
      icon: 'icon-tiaoduyizhangtu',
      menuList: 'jiankongzlMenu',
    },
    {
      name: 'zhtjyfx',
      title: '综合统计',
    ...
    },
    {
      name: 'czgzyfx',
      title: '抓拍数据',
      icon: 'icon-zhuapaishuju',
      menuList: 'czgzMenu',
    },
    {
      name: 'czsbwx',
      title: '设备维修',
      icon: 'icon-shebeiweixiu',
      menuList: 'czwxMenu',
    },
    {
      name: 'yjzhcz',
    ...
    },
    {
      name: 'zcsj',
      title: '专车数据',
      icon: 'icon-zhuancheshuju',
      menuList: 'zcsjMenu',
    },
    {
      name: 'xxgxybs',
      title: '共享报送',
      icon: 'icon-gongxiangbaosong',
      menuList: 'xxgxybsMenu',
    },
    {
      name: 'qxgl',
      title: '权限管理',
  ...
  //   jiankongzlMenu: [
  //     {
  //       href: 'app/jiankongzlMenu/jkzx.html',
  //       icon: 'icon-car',
  //       name: 'jkzx',
  //       title: '监控中心',
  //     },
  //     {
  //       href: 'app/jiankongzlMenu/duochejiankong.html',
  //       icon: 'icon-car',
  //       name: 'duochejiankong',
  //       title: '多车监控',
  //       active: true,
  //     },
  //     {
  //       href: 'app/jiankongzlMenu/spzx.html',
  //       icon: 'icon-car',
  //       name: 'spzx',
  //       title: '视频中心',
  //     },
  //     {
  //       href: 'app/jiankongzlMenu/duochegenzong.html',
  //       icon: 'icon-car',
  //       name: 'duochegenzong',
  //       title: '多车跟踪',
  //     },
